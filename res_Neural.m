...
Name = {'VanGogh Chestnut','Seurat Bridge','Levitan Oak','VanGogh Wheat','Seurat Le Chahut','Levitan Evening','VanGogh Lenna (Iris)','Seurat Lenna (Bridge)','Levitan Lenna (Oak)'};
nfiles = length(Name);
nx = 3; ny = 3; %supltols
fsize = 10; %font size
