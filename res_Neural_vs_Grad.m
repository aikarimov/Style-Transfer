...
nbins = 100;
%file name
FName = {'VanGogh_Chestnut','Seurat_Bridge','Levitan_Oak','VanGogh_Chestnut_grad','Seurat_Bridge_grad','Levitan_Oak_grad'};
%display name - add dates, correct names...
Name = {'VanGogh Chestnut (NST)','Seurat Bridge  (NST)','Levitan Oak  (NST)','VanGogh Chestnut (GRAD)','Seurat Bridge (GRAD)','Levitan Oak (GRAD)'};
nfiles = length(Name);
nx = 2; ny = 3; %supltols
fsize = 10; %font size
